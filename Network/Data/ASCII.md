ASCII(American Standard Code for Infornation Interchange): 美国信息交换标准代码是基于拉丁字母的一套电脑编码系统, 主要用于显示现代英语和其它西欧语言. 它是最通用的信息交换标准, 并等同于国际标准ISO/IEC 646. ASCII第一次以规范标准的类型发表是在1967年, 最后一次更新则实在1986年, 直到目前为止共定义了128个字符.
